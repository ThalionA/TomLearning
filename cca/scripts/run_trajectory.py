...
(this driver's --bin-ms DEFAULT; both 25 & 50 ms now re-run for the review),
PCA->K, whole-trial CV, drop saturated (CC>=0.99) windows. No depth/ISI/waveforms.
"""
...
K = 30
N_FOLDS = 5
MAX_LAG = 10                  # +-10 bins = +-250 ms at the 25 ms default (--bin-ms)
